...
def azulcor():
    ...
    lb = Label(root, text='azul', font='Time 20 italic', bg=azul)
    lb.place(width=150, height=30, x=170, y=120)


def amarelocor():
    root.configure(bg=amarelo)
    lb = Label(root, text='amarelo', font='Time 20 italic', bg=amarelo)
    lb.place(width=150, height=30, x=170, y=120)


def vermelhocor():
    root.configure(bg=vermelho)
    lb = Label(root, text='vermelho', font='Time 20 italic', bg=vermelho)
    lb.place(width=150, height=30, x=170, y=120)


def verdecor():
    root.configure(bg=verde)
    lb = Label(root, text='verde', font='Time 20 italic', bg=verde)
    lb.place(width=150, height=30, x=170, y=120)
