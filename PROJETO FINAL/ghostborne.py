def ghostborne():
    ...
    # inicio
    print('-=+> Mike <+=-')
    f1 = ['Bem vindo à Ghostborne. Um lugar esquecido.', 'Seja bem-vindo à esta cidade chamada ghostborne. Agradecimentos.']
    r1 = randint(0, 1)
    print(f1[r1])
    sleep(3)
    ...
    f1 = ['aqui será divertido, ambo do jeito assustador, e do je-', 'tenha cuidado onde vás.']
    r1 = randint(0, 1)
    print(f1[r1])
    ...
    # boss???
    while True:
        f1 = ['Entrar no alojamento de jóias', 'Entrar na loja de vestuários']
        r1 = randint(0, 1)
        print(f'1 -{f1[r1]}')
    ...
    print(f'=-' * 50)
    f1 = [' irei tentar fazer o que falaste.', ' eu vou tentar.']
    r1 = randint(0, 1)
    print(f'1 - Ok,{f1[r1]}')
    ...
    while True:
        ...
        if opc == 1:
            ...
            if vdaranha <= 0:
                ...
                sleep(1)
                print('Por isso, ganhaste mais 10 de HP!')
                print(f'=-' * 50)
                sleep(2)
                break
            print(f'=-' * 50)
    ...
    while True:
        ...
        if opc == 1:
            ...
            if vdaranha <= 0:
                print(f'Você derrubou o {bosses[boss]}!')
                sleep(1)
                print('Por isso, ganhaste mais 30 de HP!')
                print(f'=-' * 50)
                sleep(2)
                break
            print(f'=-' * 50)
