def farlight():
    ...
    # inicio
    print('-=+> Britte <+=-')
    print('Bem vindo á Farlight. Aqui é um lugar temido. ')
    sleep(3)
    print('Eu sei que aqui é um lugar pequeno, mas não deixe este olhar te enganar.')
    sleep(3)
    print('Já teve muitos casos muito aterrorizantes aqui, e...')
    sleep(3)
    ...
    if opc == 3:
        ...
        print('-=+> Britte <+=-')
        sleep(1)
        print('E só tem cuidado onde pisas, ok?')
        sleep(2)
    ...
    # boss???
    while True:
        print('1 - Entrar no alojamento de instrumentos')
